...
begin
  ...
  begin
    lbl_desc.caption:= 'A sua saúde mental está, de uma forma geral, em equilibrio! Continue assim.';
  end else
  begin
    if (pontuacao < 27) then
    begin
      lbl_desc.caption:= 'Voce esta em uma posição de alta vunerabilidade, para o Bournout. Tente se cuidar!';
    end else
    begin
       lbl_desc.caption:= 'É possivel que voce tenha desenvolvido algum grau de esgotamento profissional. ';
       lbl_pont2.Caption:='Procure um especialista!';
    end;
